...
class Teleop:  
    ...
    def __init__(self):  
        ...
        # self.deadman_button = rospy.get_param('~deadman_button', 7) # start button
        self.cmd = None
        cmd_pub = rospy.Publisher('cmd_vel', Twist)
        announce_pub = rospy.Publisher('/smartcar/announce/teleops',  String, latch=True)
